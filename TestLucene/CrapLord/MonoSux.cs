...
namespace TestLucene.CrapLord
{
    ...
    class MonoSux
    {
        ...
        [System.Security.SuppressUnmanagedCodeSecurity]
        [System.Runtime.InteropServices.DllImport(LIBC, CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, EntryPoint = "__error")]
        internal static extern Errno error(); // wrong ? 
        ...
        [System.Security.SuppressUnmanagedCodeSecurity]
        [System.Runtime.InteropServices.DllImport(LIBC, CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, EntryPoint = "__error")]
        internal static extern System.IntPtr error2(); // correct ?
        ...
        public static bool Access(string pathmame, AccessModes mode)
        {
            ...
            if (ret == -1)
            {
                ...
                // System.IntPtr errorptr = error2();
                // Errno errorno = (Errno)System.Runtime.InteropServices.Marshal.ReadInt32(errorptr);
